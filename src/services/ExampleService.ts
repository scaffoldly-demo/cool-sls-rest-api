...
export class ExampleService {
  ...
  public handleAdd = async (example: Example): Promise<Example> => {
    console.log('Added', JSON.stringify(example));
    // Here you can do any async handling of new entities
    return example;
  };

  public handleModify = async (newExample: Example, prevExample: Example): Promise<Example> => {
  ...
  public handleRemove = async (example: Example): Promise<Example> => {
